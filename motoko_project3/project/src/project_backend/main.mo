...
import Types "./Types"; // özel olarak modülleri içeriyor
...
shared actor class DAO(init : Types.BasicDaoStableStorage) = Self {
    ...
    system func heartbeat() : async () {
        await execute_accepted_proposals(); //önerilerin kabul edilmesini bekle
    };
    ...
    /// caller ile ne kadar bakiye var gösteriyoruz
